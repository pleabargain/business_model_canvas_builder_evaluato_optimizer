...
# Create tabs
tab1, tab2 = st.tabs(["Main", "README"])

with tab1:
    # create a description
    st.write(f"""This application will help you in creating, evaluating, and optimizing a business model canvas.""")
    st.write(f"""Inspired by Dries Faems at https://www.linkedin.com/in/dries-faems-0371569/""")
    ...
    st.write('Please provide a description of the different components of the business model canvas. If you do not yet have specific information for a component, you can leave it empty.')
